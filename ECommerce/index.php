...
<head>
    ...
    <title>LPA Tech eCommerce</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg  bg-primary navbar-light bg-white  py-3  fixed-top ">
            <div class="container">
            <img src="assets/imgs/lpatechlogo.png" alt="Logo" width="120" class="d-inline-block align-text-left">
        ...
        <section id="banner" class="my-5 py-5">
                <div class="container1">
                    ...
                    <div class="centered">
                        <h1>latest Phone back cover's collection from fashion 2025</h1>
        ...
        <div class=" row container mx-auto pt-5">
               <div class="footer-one col-lg-3 col-md-6 col-sm-12">
                   <img class="logo" src="assets/imgs/lpatechlogo.png"alt="Logo" width="120" class="d-inline-block align-text-left">
           ...
           <div class="footer-one col-lg-3 col-md-6 col-sm-12">
               ...
               <div class="row">
                   <img src="assets/imgs/instalogo.png" class="img-fluid w-25 h-100 m-2"/>                
               </div>
           </div>
       </div>
